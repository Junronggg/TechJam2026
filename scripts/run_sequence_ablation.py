...
EXPERIMENTS = {
    ...
    "fm_bpr_both_sequence": {
        "prior_video_positive": True,
        "author_positive_recency": True,
    },
}
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Ablate leakage-safe candidate-history features on FM+BPR"
    )
    parser.add_argument("--data-dir", default="data/KuaiRand-Pure/data")
    parser.add_argument("--output-dir", default="runs/sequence_ablation")
    ...
    for name, features in EXPERIMENTS.items():
        ...
        results[name] = {"features": features, "metrics": metrics}
